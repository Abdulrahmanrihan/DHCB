...
export default function Footer(){
    return(
        <main class="flex flex-col bg-darker md:p-24 md:pb-4">
            ...
            <div class="flex flex-row px-6 justify-between">
                <p class="text-gray md:my-auto text-xs md:w-1/3 my-6 ">© 2024 DHCB, Inc. All rights reserved</p>
                <Image class="md:flex hidden" src={logo} width={200} height={0}/>
