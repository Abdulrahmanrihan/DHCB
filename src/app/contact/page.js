...
export default function contact(){
    return (
        <main className="bg-beige">
            <Header/>
            <h1 class="text-3xl text-black text-center my-12">We are happy we can help you</h1>
            <section class="flex flex-col md:flex-row md:m-12 m-6 bg-white">
                ...
                <div class="flex flex-col w-full md:w-3/5 bg-white md:p-12 p-6 text-black">
                    <div class="flex flex-col md:flex-row md:w-1/2 justify-between md:px-8 px-6">
                    ...
                    <div style={{maxWidth:"600px"}}class="flex md:flex-row flex-col justify-between md:px-12 px-6">
                    ...
                    <div class="flex flex-col w-full md:p-12 p-6">
                        ...
                        <input type="text" placeholder="Give our team an idea of who, what and where" id="name" label="Name" class="border-gray border-b p-1"/>
                    </div>
